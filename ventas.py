...
class Ventas(tk.Frame):
    ...
    def ver_ventas_realizadas(self):
        try:
            ...
            ventana_ventas.configure(bg="#FF7E63")
            ...
            def filtrar_ventas():
                ...
                for venta in ventas_filtradas:
                    ...
                    venta[5] = "{:,.0f}".format(float(str(venta[5]).replace(" ", "")))
                    venta[6] = datetime.datetime.strptime(venta[6], "%Y-%m-%d").strftime("%d-%m-%Y")
                    tree.insert("", "end", values=venta)

            label_ventas_realizadas = tk.Label(ventana_ventas, text="ventas realizadas", font="sans 26 bold", bg="#FF7E63")
            label_ventas_realizadas.place(x=350, y=20)

            filtro_frame = tk.Frame(ventana_ventas, bg="#FF7E63")
            filtro_frame.place(x=20, y=60, width=1060, height=60)

            label_factura = tk.Label(filtro_frame, text="Numero de factura", bg="#FF7E63", font="sans 14 bold")
            ...
            label_cliente = tk.Label(filtro_frame, text="Cliente", bg="#FF7E63", font="sans 14 bold")
    ...
    def generar_factura_pdf(self, total_venta, cliente):
        try:
            ...
            empresa_telefono = "+54 2622 673467"
    ...
    def widgets(self):
        ...
        label_cliente = tk.Label(labelframe, text="Cliente: ", font="sans 14 bold", bg="#FFB7A6")
        ...
        label_producto = tk.Label(labelframe, text="Producto: ", font="sans 14 bold", bg="#FFB7A6")
        ...
        #creamos los encabezados y las columnas
        ...
        boton_ver_ventas = tk.Button(self, text="Ventas Realizadas", font="sans 14 bold", command=self.ver_ventas_realizadas)
        boton_ver_ventas.place(x=290, y=550, width=220, height=40)